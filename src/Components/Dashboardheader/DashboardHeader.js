    ...
    return (
        <div className={dashboardheader.container}>
            <div className={dashboardheader.header}>
               {!show ? <GoThreeBars onClick={handleHamburgerMenuClick} className={dashboardheader.bar_icon} /> 
                :
                <IoClose onClick={handleHamburgerMenuClick} className={dashboardheader.bar_icon} />
                }
