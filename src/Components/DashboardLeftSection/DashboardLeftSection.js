...
const data = [
  {
    icon: <FiPieChart className={dashboardleftsection.icon} />,
    name: <span className={dashboardleftsection.highlighter}>Dashboard</span>,
  },
  {
    icon: <BsTags className={dashboardleftsection.icon} />,
    name: "Transactions",
  },
  {
    icon: <TbCalendarTime className={dashboardleftsection.icon} />,
    name: "Schedules",
  },
  {
    icon: <FaRegUserCircle className={dashboardleftsection.icon} />,
    name: "Users",
  },
  {
    icon: <FiSettings className={dashboardleftsection.icon} />,
    name: "Settings",
  },
];
        ...
        <div className={dashboardleftsection.container}>
          ...
          <div className={dashboardleftsection.bottom_wrapper}>
            <div className={dashboardleftsection.menu_wrapper}>
              {data.map((element, i) => (
                <p key={i} className={dashboardleftsection.menu_options}>
            ...
            <div className={dashboardleftsection.footer}>
              ...
              <p className={dashboardleftsection.menu_options_bottom}>
                Contact Us
              </p>
            </div>
          </div>
