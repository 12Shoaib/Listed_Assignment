    ...
    <div className={dialog.container}>
      ...
      <div className={dialog.dialog_box}>
        <div className={dialog.dialog_container}>
          <label className={dialog.email_label} htmlFor="email">
            Email address
          </label>
          <input
            type="email"
            className={dialog.input_box}
            placeholder="Email"
            id="email"
          />

          <label className={dialog.password_label} htmlFor="password">
            Password
          </label>
          <input
            type="password"
            ...
            id="password"
          />
          <a className={dialog.external_Link} href="#">
            Forgot Password?
          </a>
